...
class ApplicationRouter {
  router: Router;
  constructor(protected controller: ApplicationController, protected logger: ILogger) {
    this.router = Router();
...
const applicationRouter = (controller: ApplicationController, logger: ILogger = console) =>
  new ApplicationRouter(controller, logger).router;
